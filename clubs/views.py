...
class ClubDetails(generics.RetrieveUpdateDestroyAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        return Response({ "error": "No permission to edit." }, status=status.HTTP_403_FORBIDDEN)
...
def get_club_members(request, pk):
    try:
        ...
        return Response({"error": "Could not get club members."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)